...
SECTION "GBC Colour To SGB Colour Converter", ROMX[$7900], BANK[$1]
...
PatchUtils_ColourToSGB::
	...
	; Get the address of the converted colour from the table.
	...
	call PatchUtils_FetchConvertedColour
	ld e, h
	ld d, l
...
SECTION "Fetch Converted Colour", ROM0[$12A8]
PatchUtils_FetchConvertedColour::
	rst $10
	rst $38
	ld a, 1
	rst $10
