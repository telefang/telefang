...
EventScript_EventActionTable::
    dw EventScript_StandardEnd,EventScript_OutputMessageAndContinue,EventScript_OutputMessageAndContinue,$423D,EventScript_WaitXFramesAndContinue,$4254,EventScript_StandardEnd,$428F ; 00-07
    dw $428F,$428F,$428F,$428F,EventScript_PlayerFaceDirectionAndContinue,EventScript_PlayerFaceDirectionAndContinue,EventScript_PlayerScheduleHopAndContinue,$438B ; 08-0F
    dw EventScript_PlayerScheduleWalkAndContinue,EventScript_EventFlag800SAndContinue,EventScript_EventFlag800SAndContinue,EventScript_EventFlag400S800RAndContinue,EventScript_CurrentEventFlag400S800RAndContinue,EventScript_CurrentEventFlag800RAndContinue,$4499,$449C ; 10-17
    dw $44A9,$44B7,$44D4,$44D4,$450A,$4536,$4596,$45C7 ; 18-1F
    dw $45C7,$45C7,$461B,EventScript_NPCScheduleWalkAndContinue,$4696,$4696,$46AA,EventScript_NPCScheduleHopAndContinue ; 20-27
    dw EventScript_NPCScheduleHopAndContinue,$473A,EventScript_PlayerWaitUntilDoneWalkingAndContinue,$473A,$4987,$473A,$49B4,$473A ; 28-2F
    dw $474E,$476A,$476A,$476A,EventScript_SetFlagAndContinue,EventScript_ResetFlagAndContinue,$478B,$47A5 ; 30-37
    dw EventScript_JumpIfFlagSetAndContinue,EventScript_JumpIfFlagUnsetAndContinue,$47BF,$47D6,$4A46,EventScript_NPCFacePlayerAndContinue,$4AF0,$4ABC ; 38-3F
    ...
    dw $485A,$4CD9,$4CE7,$4CF5,$4D02,$4D1D,$485A,EventScript_NPCWaitUntilDoneWalkingAndContinue ; 50-57
    ...
    dw $42D9,$4F54,$4F93,$4FA6,EventScript_EventFlag400R800RAndContinue,$4FB3,$4FCA,$4972 ; 68-6F
