...
;Decompress a tilemap or attributemap in the RLETilemap table.
; A: RLETilemap bank to index (e.g. tilemap or attribmap?)
...
RLETilemapBanks:
	db $3E ;Compressed tilemaps
	db $3F ;Compressed attribmaps