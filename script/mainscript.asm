...
SECTION "MainScript_calls_denjuu_3 Section", ROMX[$507b], BANK[$45]
...
SECTION "MainScript_calls_denjuu_5 Section", ROMX[$5c9a], BANK[$51]
MainScript_calls_denjuu_5:
	INCBIN "script\calls\denjuu\5.scripttbl"
MainScript_calls_denjuu_5_END

SECTION "MainScript_calls_denjuu_6 Section", ROMX[$5068], BANK[$26]
...
SECTION "MainScript_story_5 Section", ROMX[$41d9], BANK[$4a]
MainScript_story_5:
