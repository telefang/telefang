SECTION "MainScript_battle_items Section", ROMX[$6652], BANK[$b]
MainScript_battle_items:
	INCBIN "script/battle/items.stringtbl"
MainScript_battle_items_END

SECTION "MainScript_denjuu_nicknames Section", ROMX[$78fa], BANK[$b]
MainScript_denjuu_nicknames:
	INCBIN "script/denjuu/nicknames.stringtbl"
MainScript_denjuu_nicknames_END

SECTION "MainScript_denjuu_species Section", ROMX[$4000], BANK[$75]
MainScript_denjuu_species:
	INCBIN "script/denjuu/species.stringtbl"
MainScript_denjuu_species_END

SECTION "MainScript_battle_tfangers Section", ROMX[$4578], BANK[$75]
