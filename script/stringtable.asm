SECTION "StringTable_battle_items Section", ROMX[$6652], BANK[$b]
...
SECTION "StringTable_battle_attack_phrases Section", ROMX[$6368], BANK[$75]
...
StringTable_battle_message_unk::
	INCBIN "build/script/battle/message_unk.stringtbl"
StringTable_battle_message_unk_END::

SECTION "StringTable_denjuu_personalities Section", ROMX[$7928], BANK[$75]
StringTable_denjuu_personalities::
	INCBIN "build/script/denjuu/personalities.stringtbl"
StringTable_denjuu_personalities_END::

SECTION "StringTable_denjuu_statuses Section", ROMX[$7988], BANK[$75]
