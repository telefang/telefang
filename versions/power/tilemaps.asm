...
Tilemap_BANK_0::
	...
	dw Tilemap_phoneime_latin_upper_indicator_tmap
	...
	dw Tilemap_phoneime_latin_lower_indicator_tmap
...
Tilemap_attractmode_scene4_sgb_tmap::
	INCBIN "build/versions/power/components/attractmode/scene4/crypto_shigeki_sgb_tmap.tmap"
