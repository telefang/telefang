SECTION "SGB Attribute Data (Speed Version)", ROMX[$5000], BANK[$77]
SGB_AttrFileData::
    INCBIN "build/versions/speed/gfx/sgb/attrfile/00.atf" ; 00
    INCBIN "build/versions/speed/gfx/sgb/attrfile/01.atf" ; 01
    INCBIN "build/versions/speed/gfx/title/sgb.atf" ; 02
    ...
    INCBIN "build/versions/speed/gfx/screen/gameover.atf" ; 1A
